...
MButton:: {
    ...
    } else if MatchTitleAndCall(2, WinActive.bind('AutoHotkey Community ahk_exe msedge.exe')) or MatchTitleAndCall('RegEx', WinActive.bind('ahk_exe .EXE$')) {  ; Check if an Office app is active.
